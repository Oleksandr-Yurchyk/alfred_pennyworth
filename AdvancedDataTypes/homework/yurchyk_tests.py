import unittest
from AdvancedDataTypes.homework import yurchyk_homework
...
class DictComprehensionTestCases(unittest.TestCase):
    ...
    def test_task_1_valid_values(self):
        ...
        actual_result = yurchyk_homework.task_1_fix_names_start_letter(given_data)
    ...
    def test_task_2_valid_values(self):
        ...
        actual_result = yurchyk_homework.task_2_remove_dict_fields(given_data, redundant_keys)
...
class FilterTestCases(unittest.TestCase):
    ...
    def test_task_3_one_result(self):
        ...
        actual_result = yurchyk_homework.task_3_find_item_via_value(data=given_data, value=value_to_search)
...
class LambdaFunctionTestCases(unittest.TestCase):
    ...
    def test_task_4_check_sum(self):
        lambda_func = yurchyk_homework.task_4_return_lambda_sum_2_ints()
...
class MutableImmutableTestCases(unittest.TestCase):
    ...
    def test_task_5_list_not_mutated_by_func(self):
        lst = ["a", "b"]
        self.assertEqual(yurchyk_homework.task_5_append_str_to_list_and_return(lst, "c"), ["a", "b", "c"])
...
class StringFormattersTestCases(unittest.TestCase):
    ...
    def test_task_6_insert_callable_result_into_string(self):
        self.assertEqual(yurchyk_homework.task_6_insert_function_result_into_string(lambda: "play"),
                         "start play finish")

    def test_task_7_string_shorter(self):
        self.assertEqual(
            yurchyk_homework.task_7_insert_2_vars_into_string(5.67, "dolls"), "I have 5.6 years and I love dolls     "
        )

    def test_task_7_string_longer(self):
        self.assertEqual(
            yurchyk_homework.task_7_insert_2_vars_into_string(-6.99999, "electrocardiograms"),
